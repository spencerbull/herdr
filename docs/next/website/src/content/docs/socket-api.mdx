...
painted after an evidence-free boundary can qualify normally. Environment hints
can identify an agent for presentation, but cannot establish the exact
executable identity required by a guarded action.
